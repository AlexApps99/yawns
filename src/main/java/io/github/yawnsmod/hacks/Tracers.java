...
public class Tracers extends Hack {
    ...
    // https://www.minecraftforge.net/forum/topic/60740-1121-solved-help-to-draw-line/?do=findComment&comment=284782
    @SubscribeEvent
    public void onEntityViewRender(EntityViewRenderEvent event) {
        ...
        for (Entity entity: mc.world.getEntities(EntityOtherPlayerMP.class, (e) -> true)) {
            // Entities are being found, but it's not rendering yet...
            LOGGER.info(entity.posX + " " + entity.posY + " " + entity.posZ);
